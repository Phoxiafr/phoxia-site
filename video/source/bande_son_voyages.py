...
de 9,6 à 32,4 s, impact final sur la signature (42 s).

    python3 bande_son_voyages.py   ->  bande-son-voyages.wav (49,2 s, stéréo, 44,1 kHz)
"""
import wave
import numpy as np
...
SR = 44100
DUREE = 49.2
FIN = 42.0  # arrivée de la signature
BPM = 100
TEMPS = 60 / BPM
MESURE = 4 * TEMPS
N = int(SR * DUREE)
