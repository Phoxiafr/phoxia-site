...
de 9,6 à 35,4 s, impact final sur la signature (45 s).

    python3 bande_son_voyages.py   ->  bande-son-voyages.wav (52,2 s, stéréo, 44,1 kHz)
"""
import wave
import numpy as np
...
SR = 44100
DUREE = 52.2
FIN = 45.0  # arrivée de la signature
BPM = 100
TEMPS = 60 / BPM
MESURE = 4 * TEMPS
N = int(SR * DUREE)
...
PAYS_MONTAGE = ['SM'] * 4 + ['FR'] * 6 + ['UK'] * 2 + ['IT'] * 3 + ['SIC'] * 3 + ['TH'] * 2 + ['AND'] * 5 + ['MA'] * 3 + ['AMIS'] * 2 + ['MRS'] * 2
VIDEOS = {25, 31}  # Marrakech, Vieux-Port : toujours deux temps
d = 9.6
