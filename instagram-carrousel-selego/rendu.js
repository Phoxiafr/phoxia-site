// Génère les 5 visuels 1080 x 1350 à partir de source.html.
// Usage : node instagram-carrousel-selego/rendu.js
...
(async () => {
  ...
  for (const slide of slides) {
    ...
    await slide.screenshot({ path: path.join(dossier, `${id}-selego.jpg`), type: "jpeg", quality: 92 });
  }
